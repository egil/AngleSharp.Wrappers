...
namespace AngleSharpWrappers
{
    ...
    public partial class HtmlVideoElementWrapper : Wrapper<IHtmlVideoElement>, IHtmlVideoElement, IWrapper
    {
        ...
        /// </summary>
        internal HtmlVideoElementWrapper(WrapperFactory factory, IHtmlVideoElement initialObject, Func<object> getObject) : base(factory, initialObject, getObject) { }
        ...
        /// <inheritdoc/>
        public IAudioTrackList AudioTracks { get => GetOrWrap(() => WrappedObject.AudioTracks); }
        ...
        /// <inheritdoc/>
        public ITextTrackList TextTracks { get => GetOrWrap(() => WrappedObject.TextTracks); }

        /// <inheritdoc/>
        public String Title { get => WrappedObject.Title; set => WrappedObject.Title = value;}

        /// <inheritdoc/>
        public IVideoTrackList VideoTracks { get => GetOrWrap(() => WrappedObject.VideoTracks); }
