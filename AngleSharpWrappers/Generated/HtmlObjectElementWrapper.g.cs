...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlObjectElementWrapper : Wrapper<IHtmlObjectElement>, IHtmlObjectElement, IWrapper<IHtmlObjectElement>
    {
        ...
        /// </summary>
        internal HtmlObjectElementWrapper(WrapperFactory factory, IHtmlObjectElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IDocument? ContentDocument
        {
            get
            {
                if (_contentDocument is null || ((IWrapper)_contentDocument).IsRemoved) _contentDocument = GetOrWrap(() => WrappedObject.ContentDocument);
