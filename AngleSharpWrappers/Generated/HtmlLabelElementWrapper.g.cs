...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlLabelElementWrapper : Wrapper<IHtmlLabelElement>, IHtmlLabelElement, IWrapper<IHtmlLabelElement>
    {
        private IElement? _assignedSlot;
        private INodeList? _childNodes;
        private IHtmlMenuElement? _contextMenu;
        private IHtmlElement? _control;
        ...
        /// </summary>
        internal HtmlLabelElementWrapper(WrapperFactory factory, IHtmlLabelElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IHtmlElement? Control
        {
            get
            {
                if (_control is null || ((IWrapper)_control).IsRemoved) _control = GetOrWrap(() => WrappedObject.Control);
                return _control;
            }
        }
