...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlSelectElementWrapper : Wrapper<IHtmlSelectElement>, IHtmlSelectElement, IWrapper<IHtmlSelectElement>
    {
        private Dictionary<Int32, IHtmlOptionElement> _int32Indexer = new Dictionary<Int32, IHtmlOptionElement>();
        ...
        /// </summary>
        internal HtmlSelectElementWrapper(WrapperFactory factory, IHtmlSelectElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IHtmlFormElement? Form
        {
            get
            {
                if (_form is null || ((IWrapper)_form).IsRemoved) _form = GetOrWrap(() => WrappedObject.Form);
                return _form;
            }
        }
        ...
        public INodeList? Labels
        {
            get
            {
                if (_labels is null || ((IWrapper)_labels).IsRemoved) _labels = GetOrWrap(() => WrappedObject.Labels);
                return _labels;
            }
        }
        ...
        public IHtmlOptionsCollection Options { get => WrappedObject.Options; }
        ...
        public IHtmlCollection<IHtmlOptionElement> SelectedOptions { get => WrappedObject.SelectedOptions; }
        ...
        public void AddOption(IHtmlOptionElement element, IHtmlElement before) => WrappedObject.AddOption(element, before);
        public void AddOption(IHtmlOptionsGroupElement element, IHtmlElement before) => WrappedObject.AddOption(element, before);
        ...
        public void RemoveOptionAt(Int32 index) => WrappedObject.RemoveOptionAt(index);
        ...
        public void SetCustomValidity(String error) => WrappedObject.SetCustomValidity(error);
