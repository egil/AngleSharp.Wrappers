...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlFormElementWrapper : Wrapper<IHtmlFormElement>, IHtmlFormElement, IWrapper<IHtmlFormElement>
    {
        private Dictionary<Int32, IElement> _int32Indexer = new Dictionary<Int32, IElement>();
        private Dictionary<String, IElement> _stringIndexer = new Dictionary<String, IElement>();
        ...
        /// </summary>
        internal HtmlFormElementWrapper(WrapperFactory factory, IHtmlFormElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IElement this[String name]
        {
            ...
            {
                IElement? result;
                if (_stringIndexer.TryGetValue(name, out result) && ((IWrapper)result).IsRemoved)
                {
                    _stringIndexer.Remove(name);
                    result = null;
                }
                if (result is null)
                {
                    result = GetOrWrap(() => WrappedObject[name])!;
                    _stringIndexer.Add(name, result);
                }
                return result;
            }
        }
        ...
        public IHtmlFormControlsCollection Elements { get => WrappedObject.Elements; }
        ...
        public Boolean CheckValidity() => WrappedObject.CheckValidity();
        ...
        public DocumentRequest GetSubmission() => WrappedObject.GetSubmission();
        public DocumentRequest GetSubmission(IHtmlElement sourceElement) => WrappedObject.GetSubmission(sourceElement);
        ...
        public Boolean ReportValidity() => WrappedObject.ReportValidity();
        public void RequestAutocomplete() => WrappedObject.RequestAutocomplete();
        public void Reset() => WrappedObject.Reset();
        ...
        public Task<IDocument> SubmitAsync() => WrappedObject.SubmitAsync();
        public Task<IDocument> SubmitAsync(IHtmlElement sourceElement) => WrappedObject.SubmitAsync(sourceElement);
