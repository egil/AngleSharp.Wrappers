...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlCanvasElementWrapper : Wrapper<IHtmlCanvasElement>, IHtmlCanvasElement, IWrapper<IHtmlCanvasElement>
    {
        ...
        /// </summary>
        internal HtmlCanvasElementWrapper(WrapperFactory factory, IHtmlCanvasElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IRenderingContext GetContext(String contextId) => WrappedObject.GetContext(contextId);
        ...
        public Boolean IsSupportingContext(String contextId) => WrappedObject.IsSupportingContext(contextId);
        ...
        public void SetContext(IRenderingContext context) => WrappedObject.SetContext(context);
        public void ToBlob(Action<Stream> callback, String type) => WrappedObject.ToBlob(callback, type);
        public String ToDataUrl(String type) => WrappedObject.ToDataUrl(type);
