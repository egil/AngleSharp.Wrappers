...
namespace AngleSharpWrappers
{
    ...
    public partial class HtmlTableElementWrapper : Wrapper<IHtmlTableElement>, IHtmlTableElement, IWrapper
    {
        ...
        /// </summary>
        internal HtmlTableElementWrapper(WrapperFactory factory, IHtmlTableElement initialObject, Func<object> getObject) : base(factory, initialObject, getObject) { }
        ...
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlTableSectionElement> Bodies { get => GetOrWrap(() => WrappedObject.Bodies); }

        /// <inheritdoc/>
        public UInt32 Border { get => WrappedObject.Border; set => WrappedObject.Border = value;}

        /// <inheritdoc/>
        public IHtmlTableCaptionElement Caption { get => GetOrWrap(() => WrappedObject.Caption); set => WrappedObject.Caption = value;}
        ...
        /// <inheritdoc/>
        public IHtmlTableSectionElement Foot { get => GetOrWrap(() => WrappedObject.Foot); set => WrappedObject.Foot = value;}

        /// <inheritdoc/>
        public Boolean HasChildNodes { get => WrappedObject.HasChildNodes; }

        /// <inheritdoc/>
        public IHtmlTableSectionElement Head { get => GetOrWrap(() => WrappedObject.Head); set => WrappedObject.Head = value;}
        ...
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlTableRowElement> Rows { get => GetOrWrap(() => WrappedObject.Rows); }
        ...
        public IHtmlTableSectionElement CreateBody()
            => GetOrWrap(() => WrappedObject.CreateBody());

        /// <inheritdoc/>
        public IHtmlTableCaptionElement CreateCaption()
            => GetOrWrap(() => WrappedObject.CreateCaption());

        /// <inheritdoc/>
        public IHtmlTableSectionElement CreateFoot()
            => GetOrWrap(() => WrappedObject.CreateFoot());

        /// <inheritdoc/>
        public IHtmlTableSectionElement CreateHead()
            => GetOrWrap(() => WrappedObject.CreateHead());
        ...
        public IHtmlTableRowElement InsertRowAt(Int32 index)
            => GetOrWrap(() => WrappedObject.InsertRowAt(index));
