...
namespace AngleSharpWrappers
{
    ...
    public partial class HtmlTableRowElementWrapper : Wrapper<IHtmlTableRowElement>, IHtmlTableRowElement, IWrapper
    {
        ...
        /// </summary>
        internal HtmlTableRowElementWrapper(WrapperFactory factory, IHtmlTableRowElement initialObject, Func<object> getObject) : base(factory, initialObject, getObject) { }
        ...
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlTableCellElement> Cells { get => GetOrWrap(() => WrappedObject.Cells); }
        ...
        public IHtmlTableCellElement InsertCellAt(Int32 index, TableCellKind tableCellKind)
            => GetOrWrap(() => WrappedObject.InsertCellAt(index, tableCellKind));
