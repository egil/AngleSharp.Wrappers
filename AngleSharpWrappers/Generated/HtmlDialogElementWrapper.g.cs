...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlDialogElementWrapper : Wrapper<IHtmlDialogElement>, IHtmlDialogElement, IWrapper<IHtmlDialogElement>
    {
        ...
        /// </summary>
        internal HtmlDialogElementWrapper(WrapperFactory factory, IHtmlDialogElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public void Close(String returnValue) => WrappedObject.Close(returnValue);
        ...
        public void Show(IElement anchor) => WrappedObject.Show(anchor);
        public void ShowModal(IElement anchor) => WrappedObject.ShowModal(anchor);
