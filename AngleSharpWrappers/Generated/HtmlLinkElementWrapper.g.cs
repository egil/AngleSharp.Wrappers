...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlLinkElementWrapper : Wrapper<IHtmlLinkElement>, IHtmlLinkElement, IWrapper<IHtmlLinkElement>
    {
        ...
        /// </summary>
        internal HtmlLinkElementWrapper(WrapperFactory factory, IHtmlLinkElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IDocument? Import
        {
            get
            {
                if (_import is null || ((IWrapper)_import).IsRemoved) _import = GetOrWrap(() => WrappedObject.Import);
                return _import;
            }
        }
        ...
        public ITokenList RelationList { get => WrappedObject.RelationList; }
        ...
        public ISettableTokenList Sizes { get => WrappedObject.Sizes; }
