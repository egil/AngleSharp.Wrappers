...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlTemplateElementWrapper : Wrapper<IHtmlTemplateElement>, IHtmlTemplateElement, IWrapper<IHtmlTemplateElement>
    {
        private IElement? _assignedSlot;
        private INodeList? _childNodes;
        private IDocumentFragment? _content;
        ...
        /// </summary>
        internal HtmlTemplateElementWrapper(WrapperFactory factory, IHtmlTemplateElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IDocumentFragment? Content
        {
            get
            {
                if (_content is null || ((IWrapper)_content).IsRemoved) _content = GetOrWrap(() => WrappedObject.Content);
                return _content;
            }
        }
