...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlTableElementWrapper : Wrapper<IHtmlTableElement>, IHtmlTableElement, IWrapper<IHtmlTableElement>
    {
        private IElement? _assignedSlot;
        private IHtmlTableCaptionElement? _caption;
        ...
        private IHtmlTableSectionElement? _foot;
        private IHtmlTableSectionElement? _head;
        ...
        /// </summary>
        internal HtmlTableElementWrapper(WrapperFactory factory, IHtmlTableElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IHtmlCollection<IHtmlTableSectionElement> Bodies { get => WrappedObject.Bodies; }
        public UInt32 Border { get => WrappedObject.Border; set => WrappedObject.Border = value;}
        public IHtmlTableCaptionElement? Caption
        {
            get
            {
                if (_caption is null || ((IWrapper)_caption).IsRemoved) _caption = GetOrWrap(() => WrappedObject.Caption);
                return _caption;
            }
            set => WrappedObject.Caption = value;
        }
        ...
        public IHtmlTableSectionElement? Foot
        {
            get
            {
                if (_foot is null || ((IWrapper)_foot).IsRemoved) _foot = GetOrWrap(() => WrappedObject.Foot);
                return _foot;
            }
            set => WrappedObject.Foot = value;
        }
        ...
        public IHtmlCollection<IHtmlTableRowElement> Rows { get => WrappedObject.Rows; }
        ...
        public IHtmlTableSectionElement CreateBody() => WrappedObject.CreateBody();
        public IHtmlTableCaptionElement CreateCaption() => WrappedObject.CreateCaption();
        public IHtmlTableSectionElement CreateFoot() => WrappedObject.CreateFoot();
        public IHtmlTableSectionElement CreateHead() => WrappedObject.CreateHead();
        public void DeleteCaption() => WrappedObject.DeleteCaption();
        public void DeleteFoot() => WrappedObject.DeleteFoot();
        public void DeleteHead() => WrappedObject.DeleteHead();
        ...
        public IHtmlTableRowElement InsertRowAt(Int32 index) => WrappedObject.InsertRowAt(index);
        ...
        public void RemoveRowAt(Int32 index) => WrappedObject.RemoveRowAt(index);
