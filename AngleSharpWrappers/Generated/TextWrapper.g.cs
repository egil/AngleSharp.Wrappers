...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class TextWrapper : Wrapper<IText>, IText, IWrapper<IText>
    {
        ...
        /// </summary>
        internal TextWrapper(WrapperFactory factory, IText initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IText Split(Int32 offset) => WrappedObject.Split(offset);
