...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlMenuItemElementWrapper : Wrapper<IHtmlMenuItemElement>, IHtmlMenuItemElement, IWrapper<IHtmlMenuItemElement>
    {
        private IElement? _assignedSlot;
        private INodeList? _childNodes;
        private IHtmlElement? _command;
        ...
        /// </summary>
        internal HtmlMenuItemElementWrapper(WrapperFactory factory, IHtmlMenuItemElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IHtmlElement? Command
        {
            get
            {
                if (_command is null || ((IWrapper)_command).IsRemoved) _command = GetOrWrap(() => WrappedObject.Command);
                return _command;
            }
        }
