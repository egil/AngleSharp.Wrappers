...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlInputElementWrapper : Wrapper<IHtmlInputElement>, IHtmlInputElement, IWrapper<IHtmlInputElement>
    {
        ...
        private IHtmlDataListElement? _list;
        ...
        /// </summary>
        internal HtmlInputElementWrapper(WrapperFactory factory, IHtmlInputElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IFileList Files { get => WrappedObject.Files; }
        ...
        public IHtmlDataListElement? List
        {
            get
            {
                if (_list is null || ((IWrapper)_list).IsRemoved) _list = GetOrWrap(() => WrappedObject.List);
                return _list;
            }
        }
        ...
        public void Select(Int32 selectionStart, Int32 selectionEnd, String selectionDirection) => WrappedObject.Select(selectionStart, selectionEnd, selectionDirection);
        public void SelectAll() => WrappedObject.SelectAll();
        ...
        public void StepDown(Int32 n) => WrappedObject.StepDown(n);
        public void StepUp(Int32 n) => WrappedObject.StepUp(n);
