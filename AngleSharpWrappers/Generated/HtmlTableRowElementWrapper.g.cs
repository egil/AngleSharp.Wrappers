...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    internal sealed class HtmlTableRowElementWrapper : Wrapper<IHtmlTableRowElement>, IHtmlTableRowElement, IWrapper<IHtmlTableRowElement>
    {
        ...
        /// </summary>
        internal HtmlTableRowElementWrapper(WrapperFactory factory, IHtmlTableRowElement initialObject, Func<object?> query) : base(factory, initialObject, query) { }
        ...
        public IHtmlCollection<IHtmlTableCellElement> Cells { get => WrappedObject.Cells; }
        ...
        public IHtmlTableCellElement InsertCellAt(Int32 index, TableCellKind tableCellKind) => WrappedObject.InsertCellAt(index, tableCellKind);
        ...
        public void RemoveCellAt(Int32 index) => WrappedObject.RemoveCellAt(index);
